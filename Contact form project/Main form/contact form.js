(function () {
    'use strict'
    const emailFormProcessor = "http://cpe-web-assignments.ucdavis.edu/formprocessing/processor.php";
    const contactForm = document.getElementById("contactform");
    contactForm.addEventListener("submit", validateForm);
    // Message to be put in the element when there is an error or success...
    // The last element in this array loads the preloader css. Looks really cool..
    const feedBackMessage = [
        '<div class="error"><h3>Ooops!</h3><p>The name field is required, that\'s how I know who you are. Please fix that and try again</p>,</div>',
        '<div class="error"><h3>Ooops!</h3><p>You forgot to give me a valid email address. Please fix that and try again</p></div>',
        '<div class="error" <h3>Ooops!</h3><p>Somehow you forgot to type in your comment. Please type your comment and try again!</p></div>',
    ...
    // This displays error and success messages
    ...
    // actually send data asynchrounously
    function sendData() {
       document.getElementById("message").className = "show-message";
